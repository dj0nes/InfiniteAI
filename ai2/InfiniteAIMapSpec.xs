...
void initMapSpecific()
{
    ...
    // important: this only works after the implicit 1 second delay in the main file
    // kbUnitCount is restricted to visible targets only, until the first second of the game has passed
